            ...
            <div className="mb-6">
              ...
              <div className="flex gap-3">
                <Button
                  ...
                  variant="outline"
                  className="flex-1 border-white/20 text-white hover:bg-blue-500/20 hover:border-blue-500/50"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  className="flex-1 border-white/20 text-white hover:bg-blue-600/20 hover:border-blue-600/50"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  className="flex-1 border-white/20 text-white hover:bg-blue-700/20 hover:border-blue-700/50"
                >
