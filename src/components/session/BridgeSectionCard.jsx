...
export default function BridgeSectionCard({
  ...
  const statusColor = {
    ...
    generating: "bg-terra/10 text-terra",
  ...
  return (
    <motion.div
      ...
      className={`bg-white rounded-lg border-2 border-dashed p-4 ${
        section.bridgeStatus === "failed" ? "border-red-300" : "border-terra/40"
      }`}
    >
          ...
          {section.bridgeImageUrl ? (
            <div className="relative">
              <img
                ...
                className="w-24 h-24 object-cover rounded-lg border border-terra/30"
              />
            ...
            <div className="w-24 h-24 rounded-lg bg-terra/5 border-2 border-dashed border-terra/30 flex flex-col items-center justify-center text-terra">
        ...
        <div className="flex-1 min-w-0">
          ...
          {editing ? (
            <div className="space-y-3">
              ...
              <div>
                <label className="text-xs text-ink-muted mb-1 block">Visual Description (motion)</label>
                <Textarea
              ...
              {isOutlineStage && (
                <div>
                  <label className="text-xs text-ink-muted mb-1 block">Bridge Image Prompt (still image)</label>
                  <Textarea
            ...
            <>
              ...
              {isOutlineStage && section.bridgeImagePrompt && (
                <p className="text-sm text-terra mb-2">
          ...
          {referenceImages.length > 0 && (
            <div className="mt-2 flex items-center gap-2">
              <span className="text-xs text-ink-muted">References:</span>
          ...
          {!isOutlineStage && section.bridgeStatus === "failed" && (
            <div className="mt-3 flex flex-wrap items-center gap-2">
              <Button
                ...
                disabled={loading}
                className="text-terra border-terra/40"
              >
