...
// Brand intro is priced flat, whatever the selected length. Keep in sync with
// INTRO_CREDITS in credits.service.js on the backend.
export const INTRO_CREDITS = 3;
